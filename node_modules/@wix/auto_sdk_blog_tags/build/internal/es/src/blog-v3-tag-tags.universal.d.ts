...
export interface BlogTagNonNullableFields {
    _id: string;
    label: string;
    slug: string;
    postCount: number;
 ...
 * @slug created
 */
export declare function onTagCreated(handler: (event: TagCreatedEnvelope) => void | Promise<void>): void;
 ...
 * @slug deleted
 */
export declare function onTagDeleted(handler: (event: TagDeletedEnvelope) => void | Promise<void>): void;
 ...
 * @slug updated
 */
export declare function onTagUpdated(handler: (event: TagUpdatedEnvelope) => void | Promise<void>): void;
/**
 ...
 */
export declare function createTag(label: string, options?: CreateTagOptions): Promise<CreateTagResponse & CreateTagResponseNonNullableFields>;
 ...
 */
export declare function getTag(tagId: string, options?: GetTagOptions): Promise<BlogTag & BlogTagNonNullableFields>;
